        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                const emitFile = (f) => {
                    ...
                    const storedFile = Object.assign({ id: f._id, filename: f.filename, metadata: f.metadata || null, bucketName: streamOptions.bucketName, chunkSize: f.chunkSize, size: f.length, md5: f.md5, uploadDate: f.uploadDate, contentType: f.contentType }, request.body);
